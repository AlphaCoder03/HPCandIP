//XY - plotation with different image
...
int main()
{
    ifstream infile   ("Fig0438(a)(bld_600by600).bmp", std::ios::binary);              //input image
    ofstream debug    ("debugImageinfo1.txt");                                         //data file
    
    int lowest = 0, highest = 0,  hpixel = 0, lpixel = 0;
    int imgArray  [600][600] = { {0} };                                              //Store all data of reading file      
    int imgArrayX [600][600] = { {0} };
    int imgArrayY [600][600] = { {0} };
    
    if (infile.is_open())
    {
        ofstream outfileX ("imageInfoX1.bmp", std::ios::binary);                      //output image X
        ofstream outfileY ("imageInfoY1.bmp", std::ios::binary);                      //output image Y
        ...
        for (int  i = 0; i < 600; i++)                                              //Reading bitmap file
        {
        ...
        hpixel = imgArray [0][0];
        lpixel = imgArray [0][0];
        for (int  i = 0; i < 600; i++)                                              //Finding highest and lowest
        {
            for (int  i1 = 0; i1 < 600; i1++)    
            {
        ...
        for (int  i = 0; i < 600; i++)                                              //Finding Delta-X
        {
            for (int  i1 = 0; i1 < 600; i1++)    
            {
                if(i1 < 599)
        ...
        for (int  i = 0; i < 600; i++)                                              //Finding highest and lowest for Delta X
        {
            for (int  i1 = 0; i1 < 600; i1++)    
            {
        ...
        for (int  i = 0; i < 600; i++)                                              //Finding Normalization
        {
            for (int  i1 = 0; i1 < 600; i1++)    
            {
        ...
        for (int  i = 0; i < 600; i++)                                              //Finding Delta-Y
        {
            for (int  i1 = 0; i1 < 600; i1++)    
            {
                if(i < 599)
        ...
        for (int  i = 0; i < 600; i++)                                              //Finding highest and lowest for Delta Y
        {
            for (int  i1 = 0; i1 < 600; i1++)    
            {
        ...
        outfileX.close();
        outfileY.close();
        ifstream infileX  ("imageInfoX1.bmp", std::ios::binary);
        ifstream infileY  ("imageInfoY1.bmp", std::ios::binary);
        if (infileX.is_open() && infileY.is_open())
        {
            ofstream outfileXY ("imageInfoXY1.bmp", std::ios::binary);                    //output image XY
            for (int  i = 0; i < 54; i++)
            {
                char ch, ch1;
                infileX.read(&ch, 1);
